...
export declare function handle_basic_auth(fetch_f: typeof fetch, basicAuth: string, domain: URL): typeof fetch;
export declare function retry_fetch(fetch_f: typeof fetch, httpCodes: number[], base?: number, maxRetries?: number): typeof fetch;
export {};
