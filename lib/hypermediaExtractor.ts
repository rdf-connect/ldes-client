 ...
 */
export default function extractHypermedia (store:Store, collection: NamedNode, currentNode: NamedNode) : TREEHypermedia {
    let relationIds = store.getObjects(currentNode, new NamedNode("https://w3id.org/tree#relation"), null);
